...
import { Clock, MessageSquare, Trash2, User } from "lucide-react";
...
function SnippetCard({ snippet }: { snippet: Snippet }) {
  ...
  const comments = useQuery(api.snippets.getComments, { snippetId: snippet._id });
    ...
    >
      <Link href={`/snippets/${snippet._id}`} className="h-full block">
        ...
        >
          <div className="p-6">
            {/* Header */}
            <div className="z-999 flex items-start justify-between mb-4">
